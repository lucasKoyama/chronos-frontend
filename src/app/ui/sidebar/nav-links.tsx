        ...
        return (
          <li key={link.name}>
            <Link
              href={link.href}
              className={clsx(
                "flex h-11 grow items-center shadow-sm justify-start gap-2 rounded-md bg-gray-50 p-3 text-sm font-medium hover:bg-sky-100 hover:text-blue-600 flex-none px-3",
