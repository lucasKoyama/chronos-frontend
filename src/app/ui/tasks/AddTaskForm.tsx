'use client';
import { TaskPostPayload } from "@/app/lib/types/task";
...
export default function AddTaskForm() {
  const [taskPayload, setTaskPayload] = useState<Partial<TaskPostPayload>>({
  ...
  const addTask = (event: React.FormEvent) => {
    ...
    postTask(taskPayload as TaskPostPayload); // this "as" might be danger, week type
